...
export default function StudentAvatarSettingsPage() {
  const { user: studentUser, loading: studentLoading, refetch } = useStudentUser();
  ...
  useEffect(() => {
    if (studentUser) {
      setCurrentAvatar(studentUser.avatar?.urlMedium || studentUser.image || '/default-avatar.png');
      setUserName(studentUser.name);
      setUserEmail(studentUser.email);
    }
  }, [studentUser]);
  ...
  useEffect(() => {
    const loadImages = async () => {
      try {
        ...
        console.error('❌ [STUDENT AVATAR] Error loading images:', error);
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const data = await res.json();
      console.log('✅ [STUDENT AVATAR] Upload success:', data);
  ...
  const handleConfirmAvatar = async () => {
    ...
    try {
      ...
      console.log('✅ [STUDENT AVATAR] Avatar updated successfully');

      // ✅ Dispatcher event pour sync
      window.dispatchEvent(new CustomEvent('avatar-updated'));
      console.log('📢 [STUDENT AVATAR] avatar-updated event dispatched!');

      // ✅ Refetch du contexte
      await refetch();
      console.log('✅ [STUDENT AVATAR] Context refetched!');
      ...
      console.error('❌ [STUDENT AVATAR] Error updating avatar:', error);
