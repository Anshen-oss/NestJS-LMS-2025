...
const ToastViewport = React.forwardRef(function ToastViewport(
  props: React.ComponentPropsWithoutRef<typeof ToastPrimitives.Viewport>,
...
const ToastAction = React.forwardRef(function ToastAction(
  props: React.ComponentPropsWithoutRef<typeof ToastPrimitives.Action>,
...
const ToastClose = React.forwardRef(function ToastClose(
  props: React.ComponentPropsWithoutRef<typeof ToastPrimitives.Close>,
...
const ToastTitle = React.forwardRef(function ToastTitle(
  props: React.ComponentPropsWithoutRef<typeof ToastPrimitives.Title>,
